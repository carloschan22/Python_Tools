...
class Ui_MainWidget(object):
    def setupUi(self, MainWidget):
        ...
        self.btn_history_export.setObjectName("btn_history_export")
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.btn_history_export.setText(
            QCoreApplication.translate(
                "MainWidget", "\u5bfc\u51fa\u6c47\u603b\u8868", None
            )
        )
        self.lbl_history_year.setText(
            QCoreApplication.translate("MainWidget", "\u5e74\uff1a", None)
        )
        self.lbl_history_month.setText(
            QCoreApplication.translate("MainWidget", "\u6708\uff1a", None)
        )
        self.lbl_history_day.setText(
            QCoreApplication.translate("MainWidget", "\u65e5\uff1a", None)
        )
        self.btn_history_query.setText(
            QCoreApplication.translate("MainWidget", "\u67e5\u8be2", None)
        )
        ...
        self.aboutCopyright.setText(
            QCoreApplication.translate(
                "MainWidget",
                "Copyright \u00a9 2025 Jun Jie Tech. All rights reserved.",
                None,
            )
        )
